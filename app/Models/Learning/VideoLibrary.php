...
class VideoLibrary extends Model
{
    ...
    {
        return $this->belongsTo(User::class, 'uploaded_by'); // UPDATED
    }
    ...
    {
        return $this->hasMany(\App\Models\Learning\VideoView::class); // UPDATED
    }

    public function likes()
    {
        return $this->hasMany(\App\Models\Learning\VideoLike::class); // UPDATED
    }

    public function comments()
    {
        return $this->hasMany(\App\Models\Learning\VideoComment::class); // UPDATED
    }
    // Boot method
