                ...
                <form method="POST" action="{{ route('login') }}" class="p-8 space-y-6">
                    ...
                    <div class="grid grid-cols-3 gap-3">
                        <a href="{{ route('login.google') }}"
                            class="py-3 px-4 rounded-lg border border-slate-300 text-slate-900 font-semibold hover:bg-slate-50 transition-all duration-200 flex items-center justify-center gap-2"
