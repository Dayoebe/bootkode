    ...
    <div class="certificate-container">
        <div class="certificate-inner-border">
            ...
            <div class="certificate-header">
                ...
                <div class="institution-name">{{ config('certificate.institution.name', 'ACADEMY LEARNING PLATFORM') }}</div>
                <div class="institution-subtitle">{{ config('certificate.institution.subtitle', 'Excellence in Online Education') }}</div>
            </div>
            ...
            <div class="signatures-section">
                <div class="signature">
                    ...
                    <div class="signature-name">{{ $certificate->course->instructor->name ?? 'Course Instructor' }}</div>
            ...
            <div class="verification-section">
                <div>
                    ...
                    <div>Verify at: {{ route('certificate.verify.code', $certificate->verification_code) }}</div>
                </div>

                <div class="qr-code">
                    @if($certificate->qr_code_path && file_exists(storage_path('app/public/' . $certificate->qr_code_path)))
                        <img src="data:image/png;base64,{{ base64_encode(file_get_contents(storage_path('app/public/' . $certificate->qr_code_path))) }}" 
