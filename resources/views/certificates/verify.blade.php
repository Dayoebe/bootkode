        ...
        <div class="min-h-screen py-12 px-4 sm:px-6 lg:px-8">
            <div class="max-w-4xl mx-auto">
                        ...
                        <form id="verificationForm" class="space-y-6">
                            <div>
                                ...
                                <input 
                                    ...
                                    class="w-full px-4 py-3 bg-white bg-opacity-20 border border-white border-opacity-30 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
                                    required
                                >
                            ...
                            <button 
                                type="submit" 
                                class="w-full bg-indigo-600 hover:bg-indigo-700 text-white font-semibold py-3 px-6 rounded-lg transition-colors flex items-center justify-center"
                            >
                ...
                <div id="loadingSection" class="hidden bg-white bg-opacity-10 backdrop-blur-lg rounded-2xl p-8 text-center border border-white border-opacity-20">
                    <i class="fas fa-spinner fa-spin text-indigo-400 text-3xl mb-4"></i>
                    ...
                    <div class="bg-white bg-opacity-10 backdrop-blur-lg rounded-2xl p-8 border border-white border-opacity-20">
                        <div class="grid md:grid-cols-2 gap-8">
                            ...
                            <div class="space-y-6">
                                ...
                                <div>
                                    <h3 class="text-lg font-semibold text-white mb-4 flex items-center">
                                        <i class="fas fa-award mr-3 text-indigo-400"></i>
                                        Achievement Details
                                    </h3>
