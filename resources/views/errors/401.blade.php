...
<div class="min-h-screen flex items-center justify-center px-4 sm:px-6 py-12 bg-gradient-to-br from-blue-50 to-indigo-100">
    <div class="max-w-4xl w-full text-center">
        ...
        <div class="mt-20 grid grid-cols-2 sm:grid-cols-4 gap-6 max-w-3xl mx-auto">
            <a href="#" class="bg-white/80 backdrop-blur-sm p-4 rounded-2xl shadow-lg border border-gray-100 animate-float transform transition hover:scale-105">
                <i class="fas fa-book text-4xl text-blue-600 mb-3"></i>
                <h3 class="font-semibold text-gray-800">Academics</h3>
            </a>
            <a href="#" class="bg-white/80 backdrop-blur-sm p-4 rounded-2xl shadow-lg border border-gray-100 animate-float animation-delay-500 transform transition hover:scale-105">
                <i class="fas fa-calendar-alt text-4xl text-indigo-600 mb-3"></i>
                <h3 class="font-semibold text-gray-800">Events</h3>
            </a>
            <a href="#" class="bg-white/80 backdrop-blur-sm p-4 rounded-2xl shadow-lg border border-gray-100 animate-float animation-delay-1000 transform transition hover:scale-105">
                <i class="fas fa-graduation-cap text-4xl text-purple-600 mb-3"></i>
                <h3 class="font-semibold text-gray-800">Admissions</h3>
            </a>
            <a href="#" class="bg-white/80 backdrop-blur-sm p-4 rounded-2xl shadow-lg border border-gray-100 animate-float animation-delay-1500 transform transition hover:scale-105">
