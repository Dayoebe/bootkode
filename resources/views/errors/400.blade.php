<x-app-layout>
    <div
        class="min-h-screen flex items-center justify-center px-4 sm:px-6 py-12 bg-gradient-to-br from-blue-50 to-indigo-100">
        <div class="max-w-4xl w-full text-center">
            <div class="relative">
                <!-- Animated background elements -->
                <div
                    class="absolute -top-24 -left-20 w-64 h-64 bg-blue-200 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-blob">
                </div>
                <div
                    class="absolute -bottom-24 -right-20 w-64 h-64 bg-indigo-200 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-blob animation-delay-2000">
                </div>
                <div
                    class="absolute top-0 right-0 w-64 h-64 bg-purple-200 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-blob animation-delay-4000">
                </div>
                ...
                <div class="relative space-y-8 z-10">
                    ...
                    <h1
                        class="text-4xl md:text-5xl font-bold text-gray-800 mb-6 animate__animated animate__fadeInUp animate__delay-1s">
                        400 - Bad Request
                    </h1>

                    <p
                        class="text-xl text-gray-600 max-w-2xl mx-auto mb-10 animate__animated animate__fadeInUp animate__delay-1s">
                        The page you're looking for might have been removed, had its name changed, or is temporarily
                        unavailable.
                    </p>

                    <div
                        class="flex flex-col sm:flex-row justify-center gap-4 animate__animated animate__fadeInUp animate__delay-2s">
                        <a href="{{ url('/') }}"
            ...
            <div class="mt-20 grid grid-cols-2 sm:grid-cols-4 gap-6 max-w-3xl mx-auto">
                <a href="#"
                    class="bg-white/80 backdrop-blur-sm p-4 rounded-2xl shadow-lg border border-gray-100 animate-float transform transition hover:scale-105">
                    <i class="fas fa-book text-4xl text-blue-600 mb-3"></i>
                    <h3 class="font-semibold text-gray-800">Academics</h3>
                </a>
                <a href="#"
                    class="bg-white/80 backdrop-blur-sm p-4 rounded-2xl shadow-lg border border-gray-100 animate-float animation-delay-500 transform transition hover:scale-105">
                    <i class="fas fa-calendar-alt text-4xl text-indigo-600 mb-3"></i>
                    <h3 class="font-semibold text-gray-800">Events</h3>
                </a>
                <a href="#"
                    class="bg-white/80 backdrop-blur-sm p-4 rounded-2xl shadow-lg border border-gray-100 animate-float animation-delay-1000 transform transition hover:scale-105">
                    <i class="fas fa-graduation-cap text-4xl text-purple-600 mb-3"></i>
                    <h3 class="font-semibold text-gray-800">Admissions</h3>
                </a>
                <a href="#"
                    class="bg-white/80 backdrop-blur-sm p-4 rounded-2xl shadow-lg border border-gray-100 animate-float animation-delay-1500 transform transition hover:scale-105">
