<div class="space-y-6">
    ...
    <div class="bg-white rounded-lg shadow-sm p-6">
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center space-y-4 md:space-y-0">
            <div>
                <h2 class="text-2xl font-bold text-gray-900">Content Localization</h2>
                <p class="text-gray-600 mt-1">Manage translations and multi-language content</p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                @foreach($translationProgress as $contentType => $languages)
                    <div class="bg-gray-50 rounded-lg p-4">
                        <h4 class="font-medium text-gray-900 mb-3 capitalize">{{ str_replace('_', ' ', $contentType) }}</h4>
                        <div class="space-y-2">
                            @foreach($languages as $lang => $progress)
                                <div class="flex items-center justify-between">
                                    <div class="flex items-center space-x-2">
                                        <span class="text-sm font-medium">{{ $availableLanguages[$lang] ?? $lang }}</span>
    ...
    <div class="bg-white rounded-lg shadow-sm p-6">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
            <div>
                <label for="selectedLanguage" class="block text-sm font-medium text-gray-700 mb-1">Source Language</label>
                <select wire:model.live="selectedLanguage" id="selectedLanguage" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500">
                                    ...
                                    @foreach(['es', 'fr', 'de', 'pt'] as $lang)
                                        @if($lang !== $selectedLanguage)
                                            <button 
                                                ...
                                                class="flex items-center space-x-1 px-2 py-1 rounded text-xs font-medium
                                                    {{ rand(0, 1) ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-800' }}"
            ...
            <div class="bg-white rounded-lg max-w-4xl w-full max-h-screen overflow-y-auto">
                <div class="p-6">
                    <div class="flex justify-between items-center mb-6">
                        ...
                        <button wire:click="closeTranslationModal" class="text-gray-400 hover:text-gray-600">
                    ...
                    <form wire:submit="saveTranslation" class="space-y-6">
                        <!-- Original Content -->
                        <div class="bg-gray-50 rounded-lg p-4">
                            <h4 class="font-medium text-gray-900 mb-2">Original Content</h4>
                            <div class="space-y-2">
                                <div>
                        ...
                        <div class="grid grid-cols-1 gap-6">
                            <div>
                                <label for="translatedTitle" class="block text-sm font-medium text-gray-700 mb-1">
                                    Translated Title *
                                </label>
                                <input 
                            ...
                            <div>
                                <label for="translatedContent" class="block text-sm font-medium text-gray-700 mb-1">
                                    Translated Content *
                                </label>
                                <textarea 
