<div class="bk-edge-to-edge bg-slate-50">
    <section class="bg-slate-950 text-white">
        <div class="bk-shell grid gap-8 py-12 sm:py-16 lg:grid-cols-[0.95fr_1.05fr] lg:items-end lg:py-20">
            <div>
            ...
            <div class="grid gap-3 sm:grid-cols-3">
                <a href="mailto:oyetoke.ebenezer@gmail.com" class="rounded-2xl border border-white/10 bg-white/10 p-4 text-white transition hover:bg-white/15">
                ...
                <a href="tel:+2349030036438" class="rounded-2xl border border-white/10 bg-white/10 p-4 text-white transition hover:bg-white/15">
        ...
        <div class="bk-shell grid gap-6 lg:grid-cols-[0.8fr_1.2fr]">
            <aside class="space-y-4">
                <div class="bk-card overflow-hidden">
                    <img src="{{ asset('img/dayo.png') }}" alt="Oyetoke Adedayo Ebenezer" class="h-72 w-full object-cover object-top">
                    <div class="p-5">
                        <h2 class="text-xl font-black text-slate-950">Oyetoke Adedayo Ebenezer</h2>
                        <p class="mt-1 text-sm font-bold text-teal-700">Founder, Wireless Computer Services</p>
                ...
                <div class="bk-soft-card p-5">
                    ...
                    <div class="mt-4 grid gap-2">
                        @foreach (['Course guidance', 'Mentorship', 'Certificate questions', 'Partnerships', 'Technical support'] as $item)
                            <div class="flex items-center gap-3 rounded-2xl bg-white px-3 py-3 text-sm font-bold text-slate-700">
            ...
            <div class="bk-card p-5 sm:p-6 lg:p-8">
                ...
                @if (session('success'))
                    <div class="mt-6 rounded-2xl border border-teal-200 bg-teal-50 px-4 py-3 text-sm font-semibold text-teal-900">
                        {{ session('success') }}
                    </div>
                @endif

                @if (session('error'))
                    <div class="mt-6 rounded-2xl border border-red-200 bg-red-50 px-4 py-3 text-sm font-semibold text-red-900">
                        {{ session('error') }}
                    </div>
                @endif
