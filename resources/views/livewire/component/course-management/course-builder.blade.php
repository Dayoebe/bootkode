<div>
    <div class="bg-gray-800 p-8 rounded-2xl shadow-2xl text-white animate__animated animate__fadeIn"
        x-data="courseBuilder()">
        <div class="min-h-screen p-4 sm:p-6 lg:p-8">
            <!-- Toolbar -->
            <livewire:component.course-management.course-builder.toolbar :course="$course"
            ...
            <div class="grid grid-cols-1 lg:grid-cols-4 gap-8">
                ...
                <div class="lg:col-span-1 order-2 lg:order-1">
                    <livewire:component.course-management.course-builder.course-outline :course="$course"
                        :activeLessonId="$activeLessonId" wire:key="course-outline-{{ $course->id }}" />
                </div>

                <!-- Main Editor Area -->
                <div class="lg:col-span-3 order-1 lg:order-2">
                    @if ($activeLessonId)
                        <livewire:component.course-management.course-builder.lesson-editor :lessonId="$activeLessonId"
                            wire:key="lesson-editor-{{ $activeLessonId }}" />

                        @if ($activeQuizId)
                            <livewire:component.course-management.course-builder.quiz-editor :quizId="$activeQuizId"
                    ...
                    @else
                        ...
                        <div class="bg-gray-800 rounded-xl border border-gray-700 shadow-xl p-12 text-center">
                            <div class="max-w-md mx-auto">
                                ...
                                <p class="text-gray-400 mb-6">Select a lesson from the course outline to start writing
                                    your content. You can add text, images, videos, and files all in one place.</p>

                                <!-- Quick Stats -->
                                <div class="grid grid-cols-2 gap-4 mb-6 text-sm">
                                    <div class="bg-gray-700 p-4 rounded-lg">
                                        <div class="text-blue-400 font-bold text-2xl">{{ $course->sections->count() }}
                                        </div>
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        <div>
                                            ...
                                            <div class="relative">
                                                ...
                                                <input type="number" wire:model="course.price" min="0"
                                                    step="0.01"
