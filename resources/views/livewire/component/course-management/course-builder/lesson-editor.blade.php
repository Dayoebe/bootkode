...
<div class="space-y-6 animate__animated animate__fadeIn" x-data="{
    ...
    <div x-show="activeTab === 'settings'" class="space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="space-y-4">
                <div class="flex items-center">
                    <input type="checkbox" wire:model.live="is_free" id="is_free"
                ...
                <div class="flex items-center">
                    <input type="checkbox" wire:model="is_premium" id="is_premium"
                        class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-700 rounded bg-gray-800"
                        :disabled="$wire.is_free">
                    <label for="is_premium" class="ml-2 block text-sm text-gray-300">
                        Premium Content (requires additional payment)
                    </label>
                </div>
            </div>
        </div>
        ...
        <!-- Additional Settings -->
        <div class="bg-gray-800 rounded-lg p-6 border border-gray-700">
            <h3 class="text-lg font-medium text-white mb-4">Additional Settings</h3>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
