<div class="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-6 gap-4 mb-8">
            <!-- Main Stats -->
            <div class="lg:col-span-1 bg-gradient-to-br from-blue-500/20 to-blue-600/20 backdrop-blur-sm border border-blue-500/30 rounded-2xl p-6 hover:shadow-2xl hover:shadow-blue-500/20 transition-all duration-300">
            ...
            <div class="lg:col-span-1 bg-gradient-to-br from-purple-500/20 to-purple-600/20 backdrop-blur-sm border border-purple-500/30 rounded-2xl p-6 hover:shadow-2xl hover:shadow-purple-500/20 transition-all duration-300">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-2xl font-bold text-white">{{ number_format($totalStats['averageScore'] ?? 0, 1) }}%</p>
            ...
            <div class="lg:col-span-1 bg-gradient-to-br from-pink-500/20 to-rose-500/20 backdrop-blur-sm border border-pink-500/30 rounded-2xl p-6 hover:shadow-2xl hover:shadow-pink-500/20 transition-all duration-300">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-2xl font-bold text-white">{{ number_format(($totalStats['totalStudyTime'] ?? 0) / 60, 1) }}h</p>
            ...
            <div class="lg:col-span-1 bg-gradient-to-br from-indigo-500/20 to-indigo-600/20 backdrop-blur-sm border border-indigo-500/30 rounded-2xl p-6 hover:shadow-2xl hover:shadow-indigo-500/20 transition-all duration-300">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-2xl font-bold text-white">{{ number_format($totalStats['weeklyGoalProgress'] ?? 0, 0) }}%</p>
                    ...
                    <div class="flex flex-wrap gap-3">
                        @foreach ($achievements as $achievement)
                            <div class="bg-gradient-to-r from-yellow-500/20 to-orange-500/20 border border-yellow-500/30 rounded-xl p-3 flex items-center space-x-3 hover:shadow-lg hover:shadow-yellow-500/20 transition-all duration-300">
                                ...
                                <div>
                                    <p class="text-white font-medium text-sm">{{ $achievement['title'] ?? 'Achievement' }}</p>
                ...
                <div class="bg-gray-800/50 backdrop-blur-sm border border-gray-700/50 rounded-2xl p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div class="bg-purple-500/10 border border-purple-500/30 rounded-xl p-4">
                            ...
                            <p class="text-white text-lg font-bold">{{ $predictions['projectedLessonsNextMonth'] ?? 0 }} lessons</p>
                        ...
                        @if (isset($predictions['estimatedCompletionWeeks']) && $predictions['estimatedCompletionWeeks'])
                            <div class="bg-blue-500/10 border border-blue-500/30 rounded-xl p-4">
                                ...
                                <p class="text-white text-lg font-bold">{{ $predictions['estimatedCompletionWeeks'] }} weeks</p>
                        ...
                        <div class="bg-green-500/10 border border-green-500/30 rounded-xl p-4">
                            ...
                            <p class="text-white text-lg font-bold">{{ $predictions['recommendedStudyTime'] ?? 'Keep it up!' }}</p>
        ...
        <div class="grid grid-cols-1 xl:grid-cols-2 gap-8 mb-8">
            <!-- Activity Chart -->
            <div class="bg-gray-800/50 backdrop-blur-sm border border-gray-700/50 rounded-2xl p-6 hover:shadow-2xl hover:shadow-blue-500/10 transition-all duration-300">
                ...
                <div class="h-80">
                    <canvas 
                        x-data="chartComponent('activity', @js($activityData))" 
                        x-init="initChart" 
                        wire:ignore 
                        class="w-full h-full"
                        style="display: block;">
            ...
            <!-- Progress Chart -->
            <div class="bg-gray-800/50 backdrop-blur-sm border border-gray-700/50 rounded-2xl p-6 hover:shadow-2xl hover:shadow-green-500/10 transition-all duration-300">
                <div class="flex items-center justify-between mb-6">
                    <h3 class="text-lg font-semibold text-white flex items-center">
                ...
                <div class="h-80">
                    <canvas 
                        x-data="chartComponent('progress', @js($progressData))" 
                        x-init="initChart" 
                        wire:ignore 
                        class="w-full h-full"
                        style="display: block;">
            ...
            <!-- Performance Chart -->
            <div class="bg-gray-800/50 backdrop-blur-sm border border-gray-700/50 rounded-2xl p-6 hover:shadow-2xl hover:shadow-purple-500/10 transition-all duration-300">
                <div class="flex items-center justify-between mb-6">
                    <h3 class="text-lg font-semibold text-white flex items-center">
                        <span class="w-2 h-2 bg-purple-400 rounded-full mr-2"></span>
                ...
                <div class="h-80">
                    <canvas 
                        x-data="chartComponent('performance', @js($performanceData))" 
                        x-init="initChart" 
                        wire:ignore 
                        class="w-full h-full"
                        style="display: block;">
            ...
            <div class="bg-gray-800/50 backdrop-blur-sm border border-gray-700/50 rounded-2xl p-6 hover:shadow-2xl hover:shadow-indigo-500/10 transition-all duration-300">
                <div class="flex items-center justify-between mb-6">
                    <h3 class="text-lg font-semibold text-white flex items-center">
                ...
                <div class="h-80">
                    <canvas 
                        x-data="chartComponent('weekly', @js($weeklyProgressData))" 
                        x-init="initChart" 
                        wire:ignore 
                        class="w-full h-full"
                        style="display: block;">
        ...
        <div class="mb-8">
            <div class="bg-gray-800/50 backdrop-blur-sm border border-gray-700/50 rounded-2xl p-6 hover:shadow-2xl hover:shadow-yellow-500/10 transition-all duration-300">
                <div class="flex items-center justify-between mb-6">
                    <h3 class="text-lg font-semibold text-white flex items-center">
                        <span class="w-2 h-2 bg-yellow-400 rounded-full mr-2"></span>
                ...
                <div class="h-96">
                    <canvas 
                        x-data="chartComponent('category', @js($categoryDistributionData))" 
                        x-init="initChart" 
                        wire:ignore 
                        class="w-full h-full"
                        style="display: block;">
                    ...
                    <table class="min-w-full divide-y divide-gray-700/50">
                        <thead class="bg-gray-700/30">
                            <tr>
                                ...
                                <th class="px-6 py-4 text-left text-xs font-medium text-gray-400 uppercase tracking-wider">Last Accessed</th>
                                ...
                                <tr class="hover:bg-gray-700/20 transition-colors duration-200">
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center">
                                            ...
                                            <div>
                                                <p class="text-sm font-medium text-white">{{ $course->title ?? 'Course Title' }}</p>
                                                <p class="text-xs text-gray-400">{{ ucfirst($course->difficulty_level ?? 'beginner') }}</p>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        ...
                                        <span class="text-xs text-gray-400">{{ $course->pivot->progress ?? 0 }}%</span>
                                    </td>
        ...
        @else
            ...
            <div class="bg-gray-800/50 backdrop-blur-sm border border-gray-700/50 rounded-2xl p-12 text-center">
                ...
                <a href="{{ route('courses.index') }}" class="inline-flex items-center px-4 py-2 rounded-lg text-sm font-medium bg-blue-500/20 text-blue-400 border border-blue-500/30 hover:bg-blue-500/30 hover:text-blue-300 transition-all duration-200">
...
document.addEventListener('alpine:init', () => {
    Alpine.data('chartComponent', (type, data) => ({
        ...
        init() {
            this.initChart(); // ensure chart is initialized on mount
        },
        ...
        initChart() {
            ...
            try {
                ...
                if (this.$wire) {
                    this.$wire.on('refreshCharts', () => this.updateChart());
                }
            ...
            if (this.chartType === 'activity') {
                return {
                    ...
                    y: {
                        ...baseScale,
                        beginAtZero: true,
                        title: { display: true, text: 'Lessons', color: '#9ca3af' }
                    },
                    y1: {
                        ...baseScale,
                        type: 'linear',
        ...
        updateChart() {
            if (this.chart) {
                try {
                    const updatedData = this.$wire?.get(this.getDataProperty());
                    if (updatedData && updatedData.labels && updatedData.datasets) {
        ...
        getDataProperty() {
            ...
            return propertyMap[this.chartType] || 'activityData';
        }
    }));
});

// Loading states
document.addEventListener('livewire:loading', () => document.body.style.cursor = 'wait');
document.addEventListener('livewire:loaded', () => document.body.style.cursor = 'default');
