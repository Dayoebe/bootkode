    ...
    @if($activeTab === 'downloaded')
        @if($downloadedContent->isEmpty())
            <div class="bg-gray-800 rounded-xl shadow-lg border border-gray-700 p-8 text-center">
                ...
                <button wire:click="activeTab = 'available'"
        ...
        @else
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-6">
                @foreach($downloadedContent as $content)
                    <div
                        class="bg-gray-800 rounded-xl shadow-lg border border-gray-700 overflow-hidden hover:border-orange-500 transition-colors">
                        <div class="relative">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-6">
                @foreach($availableCourses as $course)
                    <div
                        class="bg-gray-800 rounded-xl shadow-lg border border-gray-700 overflow-hidden hover:border-orange-500 transition-colors">
                        <div class="relative">
                            <img src="{{ asset('storage/' . ($content->course->thumbnail ?? 'images/default-course.png')) }}" alt="{{ $course->title }}"
                            ...
                            @if($isDownloading && $selectedCourse == $course->id)
                                <div class="mb-3">
                                    ...
                                    <div class="w-full bg-gray-700 rounded-full h-2">
                                        <div class="bg-orange-500 h-2 rounded-full" style="width: {{ $downloadProgress }}%"></div>
                                    </div>
                                </div>
                            @else
