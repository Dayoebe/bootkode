<div class="bg-white dark:bg-gray-900 rounded-xl p-6">
    ...
    <div class="bg-gray-50 dark:bg-gray-800 rounded-xl p-5 mb-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-4">
            ...
            <select wire:model.live="categoryFilter"
                class="bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 text-gray-900 dark:text-white rounded-lg px-4 py-3">
    ...
    @if($courses->count() > 0)
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            @foreach($courses as $course)
                <div
                    class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 hover:shadow-lg transition-all duration-300 overflow-hidden group">
                    ...
                    <div class="p-5">
                        <div class="flex justify-between items-start mb-3">
                            ...
                            <div class="flex items-center text-yellow-400 ml-2">
                                ...
                                <span
                                    class="text-sm font-medium ml-1 text-gray-700 dark:text-gray-300">{{ number_format($course->reviews_avg_rating ?? 0, 1) }}</span>
                            </div>
                        </div>
    ...
    @else
        <!-- Empty State -->
        <div
            class="bg-gray-50 dark:bg-gray-800 border border-dashed border-gray-300 dark:border-gray-700 rounded-xl p-10 text-center">
            ...
            <p class="text-gray-500 dark:text-gray-400 mb-6 max-w-md mx-auto">Try adjusting your search filters or search
                terms to find what you're looking for.</p>
            <button wire:click="resetFilters"
                class="inline-flex items-center px-4 py-2.5 bg-blue-600 hover:bg-blue-700 text-white rounded-lg text-sm font-medium transition-colors">
                <i class="fas fa-redo-alt mr-2"></i> Reset Filters
            </button>
        </div>
    @endif
                                ...
                                <div class="space-y-4">
                                    <div class="flex justify-between items-center">
                                        ...
                                        <div class="flex items-center">
                                            ...
                                            <span
                                                class="text-gray-900 dark:text-white font-medium">{{ $previewCourse->instructor->name }}</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="flex justify-between">
                                        ...
                                        <span
                                            class="text-gray-900 dark:text-white font-medium capitalize">{{ $previewCourse->difficulty_level }}</span>
                                    </div>
                                    <div class="flex justify-between">
                                        <span class="text-gray-600 dark:text-gray-300">Students:</span>
                                        <span
                                            class="text-gray-900 dark:text-white font-medium">{{ $previewCourse->enrollments_count }}
                                            enrolled</span>
                                    </div>
                                    <div class="flex justify-between">
