                        ...
                        <div class="bg-gray-700 rounded-lg border border-gray-600 p-4 hover:border-orange-500 transition-colors">
                            <div class="flex justify-between items-start mb-2">
                                ...
                                <button wire:click="removeBookmark('{{ $bookmark->id }}')"
                                    class="text-gray-400 hover:text-orange-500 transition-colors" title="Remove bookmark">
    ...
    @else
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            @forelse($savedResources as $bookmark)
                <div
                    class="bg-gray-800 rounded-xl shadow-lg border border-gray-700 p-5 hover:border-orange-500 transition-colors">
