...
<form wire:submit.prevent="{{ $activeView === 'create' ? 'createAssessment' : 'updateAssessment' }}" 
    ...
    <div class="space-y-4">
        <h4 class="text-gray-800 dark:text-white font-medium transition-colors duration-300">Assessment Type</h4>
    ...
    <div class="bg-themed-tertiary dark:bg-gray-700 rounded-lg p-6 border border-themed-primary dark:border-gray-600 transition-colors duration-300">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2 transition-colors duration-300">
                    Pass Percentage <span class="text-red-600 dark:text-red-400">*</span>
                </label>
                <div class="relative">
        ...
        @if($assessmentType === 'quiz')
            <div class="mt-6">
                <h5 class="text-sm font-medium text-gray-700 dark:text-gray-300 mb-3 transition-colors duration-300">Quiz Settings</h5>
        ...
        <div class="mt-6 space-y-4">
            <div class="flex items-center justify-between">
                <div>
                    <label class="text-sm font-medium text-gray-700 dark:text-gray-300 transition-colors duration-300">Mandatory for Completion</label>
                    <p class="text-xs text-gray-600 dark:text-gray-500 transition-colors duration-300">Students must pass this assessment to complete the lesson</p>
                </div>
                <label class="relative inline-flex items-center cursor-pointer">
                    <input type="checkbox" wire:model="isMandatory" class="sr-only peer">
                    <div class="w-11 h-6 bg-gray-300 dark:bg-gray-600 peer-focus:outline-none peer-focus:ring-4 
                               peer-focus:ring-purple-300 dark:peer-focus:ring-purple-800 rounded-full peer peer-checked:after:translate-x-full 
            ...
            <div class="flex items-center justify-between">
                <div>
                    <label class="text-sm font-medium text-gray-700 dark:text-gray-300 transition-colors duration-300">Allow Multiple Attempts</label>
                    <p class="text-xs text-gray-600 dark:text-gray-500 transition-colors duration-300">Students can retake this assessment if they fail</p>
                </div>
                <label class="relative inline-flex items-center cursor-pointer">
            ...
            <div class="flex items-center justify-between">
                <div>
                    <label class="text-sm font-medium text-gray-700 dark:text-gray-300 transition-colors duration-300">Show Results Immediately</label>
                    <p class="text-xs text-gray-600 dark:text-gray-500 transition-colors duration-300">Display results and feedback after submission</p>
                </div>
                <label class="relative inline-flex items-center cursor-pointer">
        ...
        <div class="bg-themed-tertiary dark:bg-gray-700 rounded-lg p-6 border border-themed-primary dark:border-gray-600 transition-colors duration-300">
            ...
            @if($assessmentType === 'project')
                <div class="space-y-3 text-sm text-gray-700 dark:text-gray-300 transition-colors duration-300">
                    ...
                    <ul class="list-disc list-inside space-y-1 ml-4 text-gray-600 dark:text-gray-400">
                    ...
                    <div class="bg-blue-50 dark:bg-blue-900/30 border border-blue-200 dark:border-blue-700 rounded p-3 mt-4 transition-colors duration-300">
