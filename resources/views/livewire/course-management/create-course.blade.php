<div class="min-h-screen bg-gray-50 dark:bg-gray-900 transition-colors duration-300 p-4 sm:p-6" x-data="{
    ...
    <div class="mb-6 sm:mb-8">
        <div
            ...
            <div class="relative">
                ...
                <div class="grid grid-cols-5 gap-1 text-xs text-gray-500 dark:text-gray-400 mt-2">
        ...
        <form wire:submit="save">
                        ...
                        <div class="space-y-4 sm:space-y-6">
                            ...
                            <div class="group">
                                ...
                                <select wire:model="category_id"
                                    class="w-full px-3 sm:px-4 py-3 bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-transparent text-gray-900 dark:text-white transition-all duration-200 group-hover:border-purple-400">
                        ...
                        <div class="space-y-4 sm:space-y-6">
                            <div>
                                ...
                                <textarea wire:model="description" rows="8"
                                    class="w-full px-3 sm:px-4 py-3 bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 resize-none transition-colors duration-300"
                            ...
                            <div>
                                ...
                                <input type="text" wire:model="target_audience"
                                    class="w-full px-3 sm:px-4 py-3 bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 transition-colors duration-300"
                                        ...
                                        <div class="flex items-center gap-3" wire:key="outcome-{{ $index }}">
                                            <div class="flex-1">
                                                <input type="text" wire:model="learning_outcomes.{{ $index }}"
                                                    class="w-full px-3 sm:px-4 py-2 sm:py-3 bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:ring-2 focus:ring-indigo-500 text-sm sm:text-base transition-colors duration-300"
                            ...
                            <div
                                ...
                                <div class="space-y-3">
                                    @foreach ($prerequisites as $index => $prereq)
                                        <div class="flex items-start gap-3" wire:key="prereq-{{ $index }}">
                                            <div class="flex-1">
                                                <textarea wire:model="prerequisites.{{ $index }}" rows="2"
                                                    class="w-full px-3 sm:px-4 py-2 sm:py-3 bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 resize-none focus:ring-2 focus:ring-orange-500 text-sm sm:text-base transition-colors duration-300"
                        ...
                        <div class="space-y-4 sm:space-y-6">
                            ...
                            <div>
                                ...
                                <textarea wire:model="syllabus_overview" rows="6"
                                    class="w-full px-3 sm:px-4 py-3 bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-transparent text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 resize-none text-sm sm:text-base transition-colors duration-300"
                                        ...
                                        <div class="bg-white dark:bg-gray-700/50 p-3 sm:p-4 rounded-lg border border-gray-200 dark:border-gray-600 transition-colors duration-300"
                                            ...
                                            <div class="space-y-3">
                                                ...
                                                <textarea wire:model="faqs.{{ $index }}.answer" rows="2"
                                                    class="w-full px-3 sm:px-4 py-2 bg-gray-50 dark:bg-gray-600/50 border border-gray-200 dark:border-gray-500 rounded-lg text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 resize-none focus:ring-2 focus:ring-purple-500 text-sm sm:text-base transition-colors duration-300"
            ...
            <div class="mt-6 sm:mt-8 flex flex-col sm:flex-row justify-between gap-3 sm:gap-0">
                <button type="button" x-show="currentStep > 1" @click="$wire.previousStep()"
                    class="px-4 sm:px-6 py-3 bg-gray-600 hover:bg-gray-700 text-white rounded-xl transition-colors flex items-center justify-center gap-2 text-sm sm:text-base">
                ...
                <div class="flex flex-col sm:flex-row gap-3 sm:gap-4">
                    <button type="button" x-show="currentStep < totalSteps" @click="$wire.nextStep()"
                        class="px-4 sm:px-6 py-3 bg-purple-600 hover:bg-purple-700 text-white rounded-xl transition-colors flex items-center justify-center gap-2 text-sm sm:text-base">
                        Next
