    ...
    <div class="px-4 py-4 sm:px-6 sm:py-6 lg:px-8 lg:py-8" x-data="{
            ...
            <div class="flex flex-col lg:flex-row lg:items-center justify-between mb-6 lg:mb-8">
                <div class="flex flex-col sm:flex-row sm:items-center mb-6 lg:mb-0">
                    <div class="relative mb-4 sm:mb-0 sm:mr-6 self-start sm:self-auto">
                        <div class="bg-gradient-to-r from-blue-600 to-purple-600 p-4 sm:p-5 rounded-2xl sm:rounded-3xl shadow-xl">
                    ...
                    <div>
                        <h1 class="text-3xl sm:text-4xl lg:text-5xl font-black bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent mb-2">
                            Course Explorer
                        </h1>
                ...
                <div class="flex flex-col sm:flex-row gap-3 sm:gap-4">
                    <button @click="viewMode = viewMode === 'grid' ? 'list' : 'grid'"
                        ...
                        <span class="text-sm sm:text-base" x-text="viewMode === 'grid' ? 'List View' : 'Grid View'"></span>
                    </button>
                ...
                <div class="bg-gray-50 dark:bg-gray-700/50 rounded-xl sm:rounded-2xl p-4 sm:p-6 transform hover:scale-105 transition-all duration-300 border border-gray-200 dark:border-gray-600">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-gray-600 dark:text-gray-400 font-semibold text-sm sm:text-base transition-colors duration-300">Courses Available</p>
                        </div>
                ...
                <div class="bg-gray-50 dark:bg-gray-700/50 rounded-xl sm:rounded-2xl p-4 sm:p-6 transform hover:scale-105 transition-all duration-300 border border-gray-200 dark:border-gray-600">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-gray-600 dark:text-gray-400 font-semibold text-sm sm:text-base transition-colors duration-300">Currently Enrolled</p>
                        </div>
                        <div class="bg-emerald-100 dark:bg-emerald-900/50 p-3 sm:p-4 rounded-xl transition-colors duration-300">
                            <i class="fas fa-user-graduate text-emerald-600 dark:text-emerald-400 text-xl sm:text-2xl"></i>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-gray-50 dark:bg-gray-700/50 rounded-xl sm:rounded-2xl p-4 sm:p-6 transform hover:scale-105 transition-all duration-300 border border-gray-200 dark:border-gray-600">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-gray-600 dark:text-gray-400 font-semibold text-sm sm:text-base transition-colors duration-300">Courses Completed</p>
                        </div>
        ...
        <div x-show="showFilters" 
            ...
            <div class="flex flex-col sm:flex-row sm:items-center justify-between mb-6 sm:mb-8">
                <h3 class="text-xl sm:text-2xl font-black text-gray-900 dark:text-white flex items-center mb-4 sm:mb-0 transition-colors duration-300">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-4 sm:gap-6">
                ...
                <div class="col-span-full xl:col-span-2">
                    <label class="block text-sm font-bold text-gray-700 dark:text-gray-300 mb-2 transition-colors duration-300">Search Courses</label>
                    <div class="relative">
                ...
                <!-- Category Filter -->
                <div>
                    <label class="block text-sm font-bold text-gray-700 dark:text-gray-300 mb-2 transition-colors duration-300">Category</label>
                ...
                <!-- Difficulty Filter -->
                <div>
                    <label class="block text-sm font-bold text-gray-700 dark:text-gray-300 mb-2 transition-colors duration-300">Difficulty</label>
                ...
                <!-- Sort Options -->
                <div>
                    <label class="block text-sm font-bold text-gray-700 dark:text-gray-300 mb-2 transition-colors duration-300">Sort By</label>
                ...
                <!-- Special Filters -->
                <div class="col-span-full xl:col-span-2">
                    <label class="block text-sm font-bold text-gray-700 dark:text-gray-300 mb-3 sm:mb-4 transition-colors duration-300">Special Filters</label>
                    <div class="flex flex-col sm:flex-row gap-3 sm:gap-4">
                        <label class="flex items-center cursor-pointer group">
                            ...
                            <span class="ml-2 sm:ml-3 text-gray-700 dark:text-gray-300 font-medium group-hover:text-green-600 dark:group-hover:text-green-400 transition-colors duration-200 text-sm sm:text-base">Free Only</span>
                        </label>
                        ...
                        <label class="flex items-center cursor-pointer group">
                            ...
                            <span class="ml-2 sm:ml-3 text-gray-700 dark:text-gray-300 font-medium group-hover:text-purple-600 dark:group-hover:text-purple-400 transition-colors duration-200 text-sm sm:text-base">With Certificate</span>
                        </label>
                    </div>
                </div>
            </div>
        ...
        <div :class="viewMode === 'grid' ? 'grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-3 sm:gap-4 md:gap-5' : 'space-y-4 sm:space-y-6'"
            ...
            @forelse($courses as $course)
                <div class="bg-white dark:bg-gray-800 rounded-xl sm:rounded-2xl shadow-lg overflow-hidden border border-gray-200 dark:border-gray-700 transition-all duration-300 hover:shadow-xl hover:-translate-y-1 hover:scale-[1.02]"
                    ...
                    <div class="relative" :class="viewMode === 'list' ? 'w-full sm:w-48 flex-shrink-0' : 'h-36 sm:h-40'">
                        ...
                        @else
                            <div class="w-full h-full flex items-center justify-center bg-gradient-to-br from-blue-500 via-purple-600 to-pink-500">
                        ...
                        <div class="absolute top-2 sm:top-3 left-2 sm:left-3 flex flex-col gap-1 sm:gap-2">
                            @if ($course->is_free)
                                <span class="bg-emerald-500/90 backdrop-blur-sm text-white text-xs font-bold px-1.5 sm:px-2 py-0.5 sm:py-1 rounded-full">
                                    FREE
                                </span>
                            @else
                                <span class="bg-blue-500/90 backdrop-blur-sm text-white text-xs font-bold px-1.5 sm:px-2 py-0.5 sm:py-1 rounded-full">
                    ...
                    <div class="p-3 sm:p-4 flex-1">
                        ...
                        <div class="flex flex-col sm:flex-row sm:items-center justify-between mb-2 gap-1 sm:gap-2">
                            <span class="px-1.5 sm:px-2 py-0.5 sm:py-1 bg-blue-100 dark:bg-blue-900/50 text-blue-800 dark:text-blue-200 text-xs font-bold rounded-full transition-colors duration-300 self-start">
                                {{ Str::limit($course->category->name ?? 'Uncategorized', 12) }}
                            </span>
                            <span class="text-gray-500 dark:text-gray-400 text-xs font-medium flex items-center transition-colors duration-300">
                        ...
                        <!-- Description -->
                        <p class="text-gray-600 dark:text-gray-300 mb-3 text-xs sm:text-sm transition-colors duration-300 line-clamp-2">
                        ...
                        <div class="flex flex-col sm:flex-row sm:items-center justify-between mb-3 gap-2">
                            <div class="flex items-center">
                                <div class="bg-gray-200 dark:bg-gray-700 rounded-full w-6 h-6 sm:w-7 sm:h-7 flex items-center justify-center mr-2 transition-colors duration-300">
                                    <i class="fas fa-user-tie text-gray-600 dark:text-gray-400 text-xs"></i>
                                </div>
                                <div>
                                    <p class="text-xs font-bold text-gray-900 dark:text-white transition-colors duration-300">
                            ...
                            <div class="flex items-center">
                                <div class="flex items-center mr-1">
                                    @for ($i = 1; $i <= 5; $i++)
                                        <i class="fas fa-star text-xs {{ ($course->average_rating ?? 0) >= $i ? 'text-yellow-400' : 'text-gray-300 dark:text-gray-600' }}"></i>
                                    @endfor
                                </div>
                                <span class="text-xs font-bold text-gray-700 dark:text-gray-300 transition-colors duration-300">
                        ...
                        <div class="grid grid-cols-2 gap-2 sm:gap-3 mb-3">
                            <div class="text-center bg-gray-50 dark:bg-gray-700/50 rounded-lg py-1.5 sm:py-2 transition-colors duration-300">
                                <div class="text-sm sm:text-base font-bold text-blue-600 dark:text-blue-400 transition-colors duration-300">
                                    {{ $course->total_enrollments }}
                                </div>
                                <div class="text-[10px] sm:text-xs text-gray-500 dark:text-gray-400 font-semibold transition-colors duration-300">Students</div>
                            </div>
                            <div class="text-center bg-gray-50 dark:bg-gray-700/50 rounded-lg py-1.5 sm:py-2 transition-colors duration-300">
                                ...
                                <div class="text-[10px] sm:text-xs text-gray-500 dark:text-gray-400 font-semibold transition-colors duration-300">Level</div>
                            </div>
                        </div>
                        ...
                        <div class="flex flex-col gap-2">
                            ...
                            <div class="flex gap-2">
                                ...
                                <button class="group bg-white hover:bg-gray-50 dark:bg-gray-700 dark:hover:bg-gray-600 text-gray-700 dark:text-gray-300 font-bold py-1.5 sm:py-2 px-2 sm:px-3 rounded-lg transition-all duration-300 transform hover:scale-105 border border-gray-200 dark:border-gray-600 text-xs">
            ...
            @empty
                <div class="col-span-full text-center py-12 sm:py-20 bg-white dark:bg-gray-800 rounded-2xl sm:rounded-3xl shadow-xl border border-gray-200 dark:border-gray-700 transition-colors duration-300">
                    <div class="bg-blue-100 dark:bg-blue-900/50 w-24 h-24 sm:w-32 sm:h-32 rounded-full flex items-center justify-center mx-auto mb-6 sm:mb-8 transition-colors duration-300">
                        <i class="fas fa-search text-4xl sm:text-6xl text-blue-600 dark:text-blue-400"></i>
                    </div>
                    <h3 class="text-2xl sm:text-3xl font-black text-gray-900 dark:text-white mb-3 sm:mb-4 transition-colors duration-300">No courses found</h3>
                    <p class="text-gray-600 dark:text-gray-400 mb-6 sm:mb-8 max-w-md mx-auto text-base sm:text-lg transition-colors duration-300">
        ...
        <!-- Enhanced Pagination -->
        @if ($courses->hasPages())
            <div class="bg-white dark:bg-gray-800 rounded-2xl sm:rounded-3xl shadow-xl p-4 sm:p-8 border border-gray-200 dark:border-gray-700 transition-colors duration-300">
                {{ $courses->links() }}
            </div>
        @endif
        ...
        <div wire:loading class="fixed inset-0 bg-black/30 backdrop-blur-sm flex items-center justify-center z-50">
            <div class="bg-white dark:bg-gray-800 rounded-2xl sm:rounded-3xl p-8 sm:p-12 flex flex-col items-center shadow-2xl border border-gray-200 dark:border-gray-700 transition-colors duration-300 mx-4">
                ...
                <span class="text-gray-800 dark:text-white font-black text-lg sm:text-xl text-center">Loading amazing courses...</span>
            </div>
        </div>
    </div>
