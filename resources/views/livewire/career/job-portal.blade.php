    ...
    <div class="bg-gradient-to-r from-blue-600 to-indigo-600 text-white">
        <div class="container mx-auto px-6 py-16">
            <div class="text-center mb-12">
                ...
                <p class="text-xl opacity-90 max-w-2xl mx-auto">Discover opportunities that match your skills and
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                        ...
                        <div>
                            <button wire:click="$set('activeTab', 'browse')"
                                class="w-full bg-blue-600 text-white px-6 py-3 rounded-xl hover:bg-blue-700 transition-all font-semibold">
                                Search Jobs
                            </button>
                        </div>
                    </div>
            ...
            @auth
                <button wire:click="$set('activeTab', 'applications')"
                    ...
                    @if(isset($jobStats['user_applications']) && $jobStats['user_applications'] > 0)
                        <span
                            class="ml-2 bg-blue-100 text-blue-600 text-xs px-2 py-1 rounded-full">{{ $jobStats['user_applications'] }}</span>
                    @endif
                </button>
                <button wire:click="$set('activeTab', 'saved')"
                    ...
                    @if(isset($jobStats['user_saved']) && $jobStats['user_saved'] > 0)
                        <span
                            class="ml-2 bg-green-100 text-green-600 text-xs px-2 py-1 rounded-full">{{ $jobStats['user_saved'] }}</span>
                    @endif
                </button>
            @endauth
        </div>
                ...
                <div class="lg:col-span-3">
                                ...
                                <div
                                    ...
                                    <div class="p-6">
                                        ...
                                        <div class="flex flex-wrap gap-2 mb-4">
                                            ...
                                            @if($job->is_featured)
                                                <span
                                                    class="bg-gradient-to-r from-pink-500 to-rose-500 text-white text-xs px-3 py-1 rounded-full font-semibold">
                                                    FEATURED
                                                </span>
                                            @endif
                                            @if($job->is_urgent)
                                                <span
                                                    class="bg-red-500 text-white text-xs px-3 py-1 rounded-full font-semibold animate-pulse">
                                                    URGENT
                                                </span>
                                            @endif
                                        </div>
                                        ...
                                        <div class="flex space-x-3">
                                            ...
                                            @auth
                                                @if($this->hasAppliedToJob($job->id))
                                                    <button disabled
                                                        class="flex-1 bg-gray-300 text-gray-500 px-4 py-3 rounded-lg cursor-not-allowed font-medium">
                                                        Applied
                                                    </button>
                                                @else
                    ...
                    @else
                        ...
                        <div class="text-center py-16">
                            ...
                            <p class="text-gray-500 mb-6">Try adjusting your filters or search terms to find more opportunities.
                            </p>
                                ...
                                <div class="flex items-start justify-between">
                                    <div class="flex items-center space-x-4">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-sm text-gray-500">Applied {{ $application->created_at->diffForHumans() }}
                                            </p>
                                        </div>
                                    </div>
                            ...
                            <div class="bg-gray-50 rounded-xl p-6 sticky top-0">
                                ...
                                <div class="space-y-4">
                                    ...
                                    <div>
                                        ...
                                        <dd class="text-lg text-gray-900">{{ $selectedJob->work_type_icon }}
                                    ...
                                    @if($selectedJob->application_deadline)
                                        <div>
                                            ...
                                            <dd class="text-lg text-orange-600 font-medium">
                                                {{ $selectedJob->days_until_deadline }}</dd>
                                        </div>
                                    @endif

                                    <div>
                                        <dt class="text-sm font-medium text-gray-500">Posted</dt>
                                        <dd class="text-lg text-gray-900">{{ $selectedJob->created_at->diffForHumans() }}
                                        </dd>
                                    </div>
                                </div>
    ...
    @if($showApplicationModal && $applicationJob)
        <div class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
            <div class="bg-white rounded-2xl max-w-2xl w-full max-h-[90vh] overflow-hidden">
                <div
                    class="flex justify-between items-center p-6 border-b border-gray-200 bg-gradient-to-r from-green-50 to-blue-50">
                    <div>
