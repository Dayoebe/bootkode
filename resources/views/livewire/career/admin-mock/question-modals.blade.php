...
<div class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
    <div class="bg-themed-secondary rounded-2xl max-w-3xl w-full max-h-[90vh] overflow-hidden border border-themed-primary">
        ...
        <form wire:submit.prevent="createQuestion" class="p-6 overflow-y-auto max-h-[calc(90vh-140px)]">
            ...
            <div class="flex justify-end space-x-4 mt-6 pt-6 border-t border-themed-primary">
                ...
                <button type="submit"
                    class="bg-accent-themed-primary text-white px-8 py-3 rounded-xl hover:bg-accent-themed-secondary transition-colors font-semibold">
