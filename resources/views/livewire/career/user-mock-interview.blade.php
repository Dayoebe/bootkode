                                ...
                                <div class="space-y-4">
                                    @foreach($mockInterviews->take(3) as $interview)
                                                                ...
                                                                <div class="space-y-8">
                                                                    <div class="bg-white rounded-2xl shadow-lg p-8">
                                                                        ...
                                                                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                                                                            <div class="space-y-4">
                                                                                <label class="block text-sm font-semibold text-gray-700">Interview
                                                                                    Type</label>
                                                                            ...
                                                                            <div class="space-y-4">
                                                                                <label class="block text-sm font-semibold text-gray-700">Difficulty
                                                                                    Level</label>
                                                                    ...
                                                                    <div class="bg-white rounded-2xl shadow-lg p-8">
                                                                        <h3 class="text-xl font-bold text-gray-900 mb-6">Sample Questions for
                                                                            {{ ucfirst($type) }} Interview</h3>
                                                                        <div class="space-y-4">
                                                                            @php
                                                                            ...
                                                                            @foreach(array_slice($sampleQuestions, 0, 5) as $index => $question)
                                                                                <div class="p-4 bg-gray-50 rounded-lg">
                                                                                    <div class="flex items-start">
                                                                                        <span
                                                                                            class="bg-blue-100 text-blue-600 text-sm font-medium px-2 py-1 rounded-full mr-3 mt-0.5">{{ $index + 1 }}</span>
                                                        ...
                                                        @if($activeTab === 'analytics')
                                                            <div class="space-y-8">
                                                                    ...
                                                                    <div class="bg-white rounded-2xl shadow-lg p-6">
                                                                        <div class="flex items-center">
                                                                            ...
                                                                            <div class="ml-4">
                                                                                ...
                                                                                <p class="text-2xl font-bold text-gray-900">+{{ $improvementRate }}%
                                                                                </p>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                                                                    ...
                                                                    <div class="bg-white rounded-2xl shadow-lg p-6">
                                                                        <h3 class="text-xl font-bold text-gray-900 mb-6">Performance by Interview
                                                                            Type</h3>
                                                                        <div class="space-y-4">
                                                                            <div class="flex items-center justify-between">
                                                                                <span class="text-gray-600">Technical
                                                                                    ({{ $mockInterviews->where('type', 'technical')->where('status', 'completed')->count() }})</span>
                                                                                <span class="font-semibold text-blue-600">87%</span>
                                                                            </div>
                                                                            <div class="flex items-center justify-between">
                                                                                <span class="text-gray-600">Behavioral
                                                                                    ({{ $mockInterviews->where('type', 'behavioral')->where('status', 'completed')->count() }})</span>
                                                                                <span class="font-semibold text-green-600">82%</span>
                                                                            </div>
                                                                            <div class="flex items-center justify-between">
                                                                                <span class="text-gray-600">System Design
                                                                                    ({{ $mockInterviews->where('type', 'system_design')->where('status', 'completed')->count() }})</span>
                                                                                <span class="font-semibold text-purple-600">75%</span>
                                                                            </div>
                                                                            <div class="flex items-center justify-between">
                                                                                <span class="text-gray-600">Coding
                                                                                    ({{ $mockInterviews->where('type', 'coding')->where('status', 'completed')->count() }})</span>
                                                                    ...
                                                                    <div class="bg-white rounded-2xl shadow-lg p-8">
                                                                        ...
                                                                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                                                            <div class="text-center">
                                                                                ...
                                                                                <p class="text-sm text-gray-600">Your speaking pace and clarity have
                                                                                    improved by 15% in the last month.</p>
                                                                            </div>

                                                                            <div class="text-center">
                                                                                <div
                                                                                    class="bg-green-100 p-4 rounded-full w-16 h-16 mx-auto mb-4 flex items-center justify-center">
                                                                                    <svg class="w-8 h-8 text-green-600" fill="none"
                                                                                        stroke="currentColor" viewBox="0 0 24 24">
                                                                                        <path stroke-linecap="round" stroke-linejoin="round"
                                                                                            stroke-width="2"
                                                                                ...
                                                                                <p class="text-sm text-gray-600">Confidence levels are consistently
                                                                                    high, with reduced anxiety indicators.</p>
                                                                            </div>

                                                                            <div class="text-center">
                                                                                <div
                                                                                    class="bg-purple-100 p-4 rounded-full w-16 h-16 mx-auto mb-4 flex items-center justify-center">
                                                                                    <svg class="w-8 h-8 text-purple-600" fill="none"
                                                                                        stroke="currentColor" viewBox="0 0 24 24">
                                                                                        <path stroke-linecap="round" stroke-linejoin="round"
                                                                                ...
                                                                                <p class="text-sm text-gray-600">Maintaining good eye contact 78% of the
                                                                                    time during video interviews.</p>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                @endif
                                                                ...
                                                                <form wire:submit.prevent="createInterview"
                                                                    ...
                                                                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                                                                        ...
                                                                        <div class="space-y-6">
                                                                            ...
                                                                            <div>
                                                                                <label
                                                                                    class="block text-sm font-semibold text-gray-700 mb-2">Interview
                                                                                    Title *</label>
                                                                                <input wire:model="title" type="text"
                                                                                    placeholder="e.g., Frontend Developer Technical Interview"
                                                                                    class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                                                                                @error('title') <p class="text-red-500 text-sm mt-1">{{ $message }}
                                                                                </p> @enderror
                                                                            </div>
                                                                            ...
                                                                            <div class="grid grid-cols-2 gap-4">
                                                                                <div>
                                                                                    ...
                                                                                    @error('type') <p class="text-red-500 text-sm mt-1">
                                                                                    {{ $message }}</p> @enderror
                                                                                </div>

                                                                                <div>
                                                                                    <label
                                                                                        class="block text-sm font-semibold text-gray-700 mb-2">Format
                                                                                        *</label>
                                                                                    ...
                                                                                    @error('format') <p class="text-red-500 text-sm mt-1">
                                                                                    {{ $message }}</p> @enderror
                                                                                </div>
                                                                            </div>
                                                                            ...
                                                                            <div class="grid grid-cols-2 gap-4">
                                                                                <div>
                                                                                    <label
                                                                                        class="block text-sm font-semibold text-gray-700 mb-2">Difficulty
                                                                                        Level *</label>
                                                                                    ...
                                                                                    @error('difficulty_level') <p class="text-red-500 text-sm mt-1">
                                                                                    {{ $message }}</p> @enderror
                                                                                </div>

                                                                                <div>
                                                                                    <label
                                                                                        class="block text-sm font-semibold text-gray-700 mb-2">Duration
                                                                                        (minutes) *</label>
                                                                                    <input wire:model="estimated_duration_minutes" type="number"
                                                                                        min="15" max="180" step="15"
                                                                                        class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                                                                                    @error('estimated_duration_minutes') <p
                                                                            ...
                                                                            <div class="grid grid-cols-1 gap-4">
                                                                                <div>
                                                                                    <label
                                                                                        class="block text-sm font-semibold text-gray-700 mb-2">Job
                                                                                        Role</label>
                                                                                    <input wire:model="job_role" type="text"
                                                                                        placeholder="e.g., Senior Frontend Developer"
                                                                                        class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                                                                                    @error('job_role') <p class="text-red-500 text-sm mt-1">
                                                                                    {{ $message }}</p> @enderror
                                                                                </div>
                                                                                ...
                                                                                <div class="grid grid-cols-2 gap-4">
                                                                                    <div>
                                                                                        <label
                                                                                            class="block text-sm font-semibold text-gray-700 mb-2">Industry</label>
                                                                                        <input wire:model="industry" type="text"
                                                                                            placeholder="e.g., Technology"
                                                                                            class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                                                                                        @error('industry') <p class="text-red-500 text-sm mt-1">
                                                                                        {{ $message }}</p> @enderror
                                                                                    </div>

                                                                                    <div>
                                                                                        <label
                                                                                            class="block text-sm font-semibold text-gray-700 mb-2">Company
                                                                                            Type</label>
                                                                                        <input wire:model="company_type" type="text"
                                                                                            placeholder="e.g., Startup"
                                                                                            class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                                                                                        @error('company_type') <p class="text-red-500 text-sm mt-1">
                                                                                        {{ $message }}</p> @enderror
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            ...
                                                                            <div>
                                                                                <label
                                                                                    class="block text-sm font-semibold text-gray-700 mb-2">Schedule
                                                                                    For (Optional)</label>
                                                                                <input wire:model="scheduled_at" type="datetime-local"
                                                                                    class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                                                                                @error('scheduled_at') <p class="text-red-500 text-sm mt-1">
                                                                                {{ $message }}</p> @enderror
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="space-y-6">
                                                                            ...
                                                                            <div>
                                                                                ...
                                                                                @error('description') <p class="text-red-500 text-sm mt-1">
                                                                                {{ $message }}</p> @enderror
                                                                            </div>
                                                                            ...
                                                                            <div>
                                                                                <label
                                                                                    class="block text-sm font-semibold text-gray-700 mb-2">Associated
                                                                            ...
                                                                            @if($aiAnalysisEnabled)
                                                                                <div>
                                                                                    <label
                                                                                        class="block text-sm font-semibold text-gray-700 mb-4">Premium
                                                                                        Features</label>
                                                                                    <div class="space-y-3">
                                                                                        @foreach(['ai_feedback', 'video_recording', 'detailed_analytics', 'custom_questions', 'unlimited_retakes'] as $feature)
                                                                                            <label class="flex items-center">
                                                                                                <input type="checkbox"
                                                                                                    wire:click="togglePremiumFeature('{{ $feature }}')" {{ in_array($feature, $premium_features) ? 'checked' : '' }}
                                                                            ...
                                                                            <!-- Custom Questions -->
                                                                            <div>
                                                                                <label class="block text-sm font-semibold text-gray-700 mb-2">Custom
                                                                                    Questions</label>
                                                                                            ...
                                                                                            <div
                                                                                                ...
                                                                                                <div class="flex-1">
                                                                                                    <p class="text-sm text-gray-700">
                                                                                                        {{ $question['question'] }}</p>
                                                                                                    <span
                                                                                                        class="text-xs text-gray-500">{{ ucfirst($question['type']) }}</span>
                                                                                                </div>
                                                                                                <button type="button"
                                            ...
                                            <div class="flex items-center space-x-2">
                                                <span
                                                    class="px-3 py-1 text-sm rounded-full bg-{{ $interview->getStatusColor() }}-100 text-{{ $interview->getStatusColor() }}-800">
                            ...
                            <div class="p-6 border-b border-gray-100">
                                ...
                                <div class="space-y-2 text-sm text-gray-600">
                                    <div class="flex items-center justify-between">
                                        ...
                                        <span
                                            class="font-medium px-2 py-1 rounded bg-{{ $interview->getDifficultyColor() }}-100 text-{{ $interview->getDifficultyColor() }}-800">
                                    ...
                                    @if($interview->overall_score)
                                        <div class="flex items-center justify-between">
                                            <span>Score:</span>
                                            <span
                                                class="font-bold text-{{ $interview->overall_score >= 80 ? 'green' : ($interview->overall_score >= 60 ? 'yellow' : 'red') }}-600">
                ...
                <div class="p-6 border-b border-gray-200 bg-gradient-to-r from-indigo-50 to-purple-50">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-gray-600">Question {{ $currentQuestionIndex + 1 }} of
                                {{ count($currentInterview->questions) }}</p>
                        </div>
                    ...
                    @if($currentQuestionIndex < count($currentInterview->questions))
                        ...
                        <div class="mb-8">
                            <div class="bg-gray-50 p-6 rounded-xl mb-6">
                                <h3 class="text-lg font-semibold text-gray-900 mb-2">Question {{ $currentQuestionIndex + 1 }}
                                </h3>
                                <p class="text-gray-700 text-lg">
                                    {{ $currentInterview->questions[$currentQuestionIndex]['question'] }}</p>
                            </div>
                            ...
                            <div class="space-y-4">
                                ...
                                @elseif($currentInterview->format === 'voice')
                                    <div class="text-center py-8">
                                        <button
                                            class="bg-red-600 text-white px-8 py-4 rounded-full hover:bg-red-700 transition-colors">
                ...
                <div class="overflow-y-auto max-h-[calc(90vh-120px)]">
                    <div class="p-6">
                        ...
                        <div class="text-center mb-8">
                            <div
                                class="inline-flex items-center justify-center w-32 h-32 bg-gradient-to-br from-blue-500 to-purple-600 rounded-full text-white mb-4">
                                <span
                                                ...
                                                <ul class="space-y-1">
                                                    @foreach($currentInterview->ai_feedback['strengths'] as $strength)
                                                        <li class="flex items-start">
                                                            <svg class="w-4 h-4 text-green-600 mt-0.5 mr-2 flex-shrink-0" fill="none"
                                                                stroke="currentColor" viewBox="0 0 24 24">
                                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                                    d="M5 13l4 4L19 7" />
                                                            </svg>
                                            ...
                                            <div>
                                                ...
                                                <ul class="space-y-1">
                                                    @foreach($currentInterview->ai_feedback['areas_for_improvement'] as $improvement)
                                                        <li class="flex items-start">
                                                            <svg class="w-4 h-4 text-orange-600 mt-0.5 mr-2 flex-shrink-0" fill="none"
                                                                stroke="currentColor" viewBox="0 0 24 24">
                                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <div class="bg-white border border-gray-200 rounded-xl p-6">
                                ...
                                @else
                                    <div class="text-center py-4">
                                        ...
                                        <p class="text-gray-500 text-sm">Recommendations will be generated with premium AI
                                            analysis</p>
                                    </div>
                                @endif
                            </div>
                        ...
                        @if($currentInterview->detailed_analytics_enabled)
                            <div class="mt-8 bg-gray-50 rounded-xl p-6">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                    <div class="text-center">
                                        <div class="text-2xl font-bold text-blue-600">
                                            {{ number_format($currentInterview->avg_response_time ?? 0, 1) }}s</div>
                                        <div class="text-sm text-gray-600">Avg Response Time</div>
                                    </div>
                                    <div class="text-center">
                                        <div class="text-2xl font-bold text-green-600">
                                            {{ $currentInterview->completion_rate ?? 0 }}%</div>
                                        <div class="text-sm text-gray-600">Completion Rate</div>
                                    </div>
                                    <div class="text-center">
                                        <div class="text-2xl font-bold text-purple-600">
                                            {{ $currentInterview->pause_count ?? 0 }}</div>
