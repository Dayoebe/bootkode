        ...
        <div class="container mx-auto px-6 py-8">
            ...
            <div class="bg-gray-50 rounded-2xl p-6 mb-6">
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-4">
                    <div class="relative">
                        <label class="block text-sm font-medium text-gray-700 mb-2">What job are you looking
                            for?</label>
                        ...
                        <svg class="absolute left-3 top-11 h-5 w-5 text-gray-400" fill="none" stroke="currentColor"
                            viewBox="0 0 24 24">
    ...
    <div class="container mx-auto px-6 py-8">
        ...
        @elseif (count($jobs) > 0)
            @if($view_mode === 'grid')
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                    @foreach ($jobs as $job)
                        <div wire:key="{{ $job['id'] }}"
                            class="bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 p-6 border border-gray-100 hover:border-blue-200 relative group">
                            <!-- Job Match Score -->
        ...
        @else
            ...
            <div class="text-center py-16">
                ...
                <p class="text-gray-500 mb-6">Try adjusting your search criteria or check back later for new opportunities.
                </p>
                <button wire:click="clearFilters"
