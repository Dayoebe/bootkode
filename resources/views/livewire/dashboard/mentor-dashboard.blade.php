<div class="min-h-screen bg-themed-primary transition-colors duration-300 p-4 md:p-6">
        ...
        <div class="bg-themed-secondary rounded-2xl shadow-sm border border-themed-primary p-6 relative overflow-hidden transition-colors duration-300">
            ...
            <div class="flex flex-col lg:flex-row justify-between items-start lg:items-center space-y-4 lg:space-y-0 relative">
                <div>
                    ...
                    <p class="text-themed-secondary mt-1 transition-colors duration-300">Welcome back, {{ auth()->user()->name }}! Guide your mentees to success.</p>
                ...
                <div class="flex flex-wrap items-center space-x-3">
                    <!-- Mentee Filter -->
                    <select wire:model.live="selectedMenteeFilter" class="bg-themed-secondary border border-themed-secondary text-themed-primary px-3 py-2 text-sm rounded-lg focus:ring-2 focus:ring-teal-500 dark:focus:ring-teal-400 focus:border-teal-500 dark:focus:border-teal-400 transition-colors duration-300">
                    ...
                    <!-- Quick Actions -->
                    <a href="{{ route('mentorship.hub') }}" class="bg-teal-600 dark:bg-teal-500 hover:bg-teal-700 dark:hover:bg-teal-600 text-white px-4 py-2 rounded-lg font-medium transition-colors duration-200">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <div class="bg-themed-secondary rounded-xl shadow-sm border border-themed-primary p-6 hover:shadow-md dark:hover:shadow-xl transition-all duration-200">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-sm text-themed-secondary font-medium transition-colors duration-300">Total Mentees</p>
                    <h3 class="text-3xl font-bold text-themed-primary mt-1 transition-colors duration-300">{{ $this->overviewStats['total_mentees'] }}</h3>
        ...
        <div class="bg-themed-secondary rounded-xl shadow-sm border border-themed-primary p-6 hover:shadow-md dark:hover:shadow-xl transition-all duration-200">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-sm text-themed-secondary font-medium transition-colors duration-300">Sessions Completed</p>
                    <h3 class="text-3xl font-bold text-themed-primary mt-1 transition-colors duration-300">{{ $this->overviewStats['completed_sessions'] }}</h3>
                    <div class="flex items-center mt-2 text-sm">
        ...
        <div class="bg-themed-secondary rounded-xl shadow-sm border border-themed-primary p-6 hover:shadow-md dark:hover:shadow-xl transition-all duration-200">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <h3 class="text-3xl font-bold text-themed-primary mt-1 transition-colors duration-300">{{ $this->overviewStats['success_rate'] }}%</h3>
                    <div class="flex items-center mt-2 text-sm">
                        ...
                        <span class="text-themed-tertiary transition-colors duration-300">{{ number_format($this->overviewStats['avg_session_rating'], 1) }} rating</span>
                    </div>
                </div>
        ...
        <div class="bg-themed-secondary rounded-xl shadow-sm border border-themed-primary p-6 hover:shadow-md dark:hover:shadow-xl transition-all duration-200">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-sm text-themed-secondary font-medium transition-colors duration-300">Career Placements</p>
                    <h3 class="text-3xl font-bold text-themed-primary mt-1 transition-colors duration-300">{{ $this->overviewStats['career_placements'] }}</h3>
                    <div class="flex items-center mt-2 text-sm">
    ...
    <div class="grid grid-cols-1 xl:grid-cols-3 gap-8">
        ...
        <div class="xl:col-span-2 space-y-8">
            ...
            <div class="bg-themed-secondary rounded-xl shadow-sm border border-themed-primary p-6 transition-colors duration-300">
                <div class="flex items-center justify-between mb-6">
                    <h2 class="text-xl font-bold text-themed-primary transition-colors duration-300">Mentee Progress</h2>
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex items-center justify-between p-4 bg-themed-tertiary rounded-lg hover:bg-themed-secondary transition-colors duration-200">
                        <div class="flex items-center space-x-4">
                            ...
                            <div>
                                <h4 class="font-semibold text-themed-primary transition-colors duration-300">{{ $mentee['name'] }}</h4>
                        ...
                        <div class="text-right">
                            <span class="px-3 py-1 text-xs rounded-full {{ $mentee['status'] === 'active' ? 'bg-green-100 dark:bg-green-900/30 text-green-800 dark:text-green-300' : 'bg-themed-tertiary text-themed-primary' }} transition-colors duration-300">
                                {{ ucfirst($mentee['status']) }}
                            </span>
                            <p class="text-xs text-themed-secondary mt-1 transition-colors duration-300">{{ $mentee['goals_completed'] }} goals completed</p>
                        </div>
                    </div>
                    @empty
                    <div class="text-center py-8">
                        ...
                        <a href="{{ route('mentorship.hub') }}" class="bg-teal-600 dark:bg-teal-500 hover:bg-teal-700 dark:hover:bg-teal-600 text-white px-4 py-2 rounded-lg transition-colors">
                            Find Mentees
                        </a>
                    </div>
                    @endforelse
            ...
            <div class="bg-themed-secondary rounded-xl shadow-sm border border-themed-primary p-6 transition-colors duration-300">
                <h2 class="text-xl font-bold text-themed-primary mb-6 transition-colors duration-300">Session Analytics</h2>
                
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    <!-- Session Trends Chart -->
                    <div>
                        <h3 class="text-sm font-semibold text-themed-primary mb-3 transition-colors duration-300">Session Trends</h3>
                        <div class="h-48">
                    ...
                    <div>
                        <h3 class="text-sm font-semibold text-themed-primary mb-3 transition-colors duration-300">Session Types</h3>
                        <div class="space-y-3">
                            @foreach($this->sessionAnalytics['session_types'] as $type => $percentage)
                            <div class="flex items-center justify-between">
                                <span class="text-sm text-themed-secondary capitalize transition-colors duration-300">{{ str_replace('_', ' ', $type) }}</span>
                                <div class="flex items-center space-x-2">
                                    <div class="w-20 bg-themed-tertiary rounded-full h-2 transition-colors duration-300">
                                        <div class="bg-gradient-to-r from-teal-400 to-cyan-500 dark:from-teal-300 dark:to-cyan-400 h-2 rounded-full" 
                                             style="width: {{ $percentage }}%"></div>
                                    </div>
                                    <span class="text-sm font-medium text-themed-primary transition-colors duration-300">{{ $percentage }}%</span>
                                </div>
                            </div>
                            @endforeach
                        </div>
                        ...
                        <div class="mt-6 pt-4 border-t border-themed-primary transition-colors duration-300">
                            <h4 class="text-sm font-semibold text-themed-primary mb-3 transition-colors duration-300">Success Metrics</h4>
                            <div class="grid grid-cols-2 gap-4">
                                <div class="text-center">
                                    ...
                                    <div class="text-xs text-themed-secondary transition-colors duration-300">Goal Completion</div>
                                </div>
                                <div class="text-center">
                                    ...
                                    <div class="text-xs text-themed-secondary transition-colors duration-300">Retention Rate</div>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="bg-themed-secondary rounded-xl shadow-sm border border-themed-primary p-6 transition-colors duration-300">
                <h2 class="text-xl font-bold text-themed-primary mb-6 transition-colors duration-300">Career Guidance Outcomes</h2>
                
                <div class="space-y-4">
                    @forelse($this->careerGuidance['career_outcomes']->take(5) as $outcome)
                    <div class="flex items-center justify-between p-4 border border-themed-primary rounded-lg transition-colors duration-300">
                        <div>
                            <h4 class="font-semibold text-themed-primary transition-colors duration-300">{{ $outcome['mentee_name'] }}</h4>
                    ...
                    <div class="text-center py-6">
                        ...
                        <p class="text-themed-secondary transition-colors duration-300">No career guidance data available</p>
                    </div>
                    @endforelse
                </div>
            </div>
        ...
        <div class="space-y-8">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        <div class="flex items-center justify-between mb-2">
                            <span class="text-sm font-medium text-themed-primary transition-colors duration-300">Sessions</span>
                    ...
                    <div>
                        <div class="flex items-center justify-between mb-2">
                            <span class="text-sm font-medium text-themed-primary transition-colors duration-300">Certifications</span>
                            <span class="text-sm text-themed-secondary transition-colors duration-300">
                    ...
                    <div>
                        <div class="flex items-center justify-between mb-2">
                            <span class="text-sm font-medium text-themed-primary transition-colors duration-300">Job Placements</span>
                            <span class="text-sm text-themed-secondary transition-colors duration-300">
            ...
            <div class="bg-themed-secondary rounded-xl shadow-sm border border-themed-primary p-6 transition-colors duration-300">
                <div class="flex items-center justify-between mb-6">
                    <h2 class="text-xl font-bold text-themed-primary transition-colors duration-300">Recent Mock Interviews</h2>
                ...
                <div class="space-y-3 max-h-80 overflow-y-auto">
                    ...
                    <div class="border border-themed-primary rounded-lg p-4 transition-colors duration-300">
                        <div class="flex items-start justify-between">
                            <div class="flex-1">
                                <h4 class="font-semibold text-themed-primary transition-colors duration-300">{{ $interview['mentee_name'] }}</h4>
                                <p class="text-sm text-themed-secondary transition-colors duration-300">{{ $interview['interview_type'] }}</p>
                                <div class="flex items-center mt-2 space-x-3 text-xs text-themed-secondary transition-colors duration-300">
                ...
                <div class="space-y-3 max-h-80 overflow-y-auto">
                    ...
                    <div class="flex items-center space-x-3 p-3 border border-themed-primary rounded-lg transition-colors duration-300">
                        ...
                        <div class="flex-1 min-w-0">
                            <h4 class="text-sm font-medium text-themed-primary truncate transition-colors duration-300">{{ $ticket['mentee_name'] }}</h4>
                            <p class="text-xs text-themed-secondary truncate transition-colors duration-300">{{ $ticket['subject'] }}</p>
                            <span class="text-xs text-themed-tertiary transition-colors duration-300">{{ $ticket['created_at']->format('M j, Y') }}</span>
                        </div>
            ...
            <div class="bg-themed-secondary rounded-xl shadow-sm border border-themed-primary p-6 transition-colors duration-300">
                <h2 class="text-xl font-bold text-themed-primary mb-6 transition-colors duration-300">Recent Activities</h2>
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex items-start space-x-3 p-3 rounded-lg hover:bg-themed-tertiary transition-colors duration-200">
                        ...
                        <div class="flex-1 min-w-0">
                            <p class="text-sm font-medium text-themed-primary transition-colors duration-300">{{ $activity['title'] }}</p>
                            <p class="text-xs text-themed-secondary transition-colors duration-300">{{ $activity['description'] }}</p>
                            <p class="text-xs text-themed-tertiary mt-1 transition-colors duration-300">{{ $activity['timestamp']->diffForHumans() }}</p>
                        </div>
                    </div>
                    @empty
                    <div class="text-center py-6">
