<div class="min-h-screen bg-gray-50 dark:bg-gray-900 transition-colors duration-300 p-4 md:p-6">
        ...
        <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6 mb-8">
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 p-4 lg:p-6 hover:shadow-md dark:hover:shadow-xl transition-all duration-200">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-sm text-gray-600 dark:text-gray-400 font-medium transition-colors duration-300">Enrolled</p>
                        <h3 class="text-2xl font-bold text-gray-900 dark:text-white mt-1 transition-colors duration-300">{{ $this->quickStats['enrolled_courses'] }}</h3>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 p-4 lg:p-6 hover:shadow-md dark:hover:shadow-xl transition-all duration-200">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-sm text-gray-600 dark:text-gray-400 font-medium transition-colors duration-300">Certificates</p>
                        <h3 class="text-2xl font-bold text-gray-900 dark:text-white mt-1 transition-colors duration-300">{{ $this->quickStats['certificates_earned'] }}</h3>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 p-4 lg:p-6 hover:shadow-md dark:hover:shadow-xl transition-all duration-200">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-sm text-gray-600 dark:text-gray-400 font-medium transition-colors duration-300">Avg Score</p>
                        <h3 class="text-2xl font-bold text-gray-900 dark:text-white mt-1 transition-colors duration-300">{{ number_format($this->quickStats['average_score'], 1) }}%</h3>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 p-4 lg:p-6 hover:shadow-md dark:hover:shadow-xl transition-all duration-200">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-sm text-gray-600 dark:text-gray-400 font-medium transition-colors duration-300">Study Time</p>
                        <h3 class="text-2xl font-bold text-gray-900 dark:text-white mt-1 transition-colors duration-300">{{ $this->quickStats['total_study_hours'] }}h</h3>
    ...
    <div class="grid grid-cols-1 xl:grid-cols-3 gap-8">
            ...
            @if($showWidgets['learning_progress'])
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 p-6 transition-colors duration-300">
                    <div class="flex items-center justify-between mb-6">
                        <h2 class="text-xl font-bold text-gray-900 dark:text-white transition-colors duration-300">Continue Learning</h2>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div class="border border-gray-200 dark:border-gray-600 rounded-lg p-4 hover:border-blue-300 dark:hover:border-blue-500 transition-colors duration-200">
                                <div class="flex items-start space-x-3">
                                    @if($progress['thumbnail'])
                                        <img src="{{ $progress['thumbnail'] }}" alt="{{ $progress['title'] }}" class="w-16 h-16 rounded-lg object-cover">
                                    @else
                                        <div class="w-16 h-16 bg-blue-100 dark:bg-blue-900/30 rounded-lg flex items-center justify-center transition-colors duration-300">
                                            <i class="fas fa-book text-blue-600 dark:text-blue-400"></i>
                                        </div>
                                    @endif

                                    <div class="flex-1 min-w-0">
                                        <h3 class="font-semibold text-gray-900 dark:text-white truncate transition-colors duration-300">{{ $progress['title'] }}</h3>
                                        <!-- Progress bar -->
                                        <div class="w-full bg-gray-200 dark:bg-gray-600 rounded-full h-2 mt-2 transition-colors duration-300">
                                            <div class="bg-gradient-to-r from-blue-500 to-purple-500 dark:from-blue-400 dark:to-purple-400 h-2 rounded-full" style="width: {{ $progress['progress'] }}%"></div>
                                        </div>
                                        <div class="flex items-center justify-between mt-1 text-xs text-gray-600 dark:text-gray-400 transition-colors duration-300">
                                    ...
                                    <div class="text-xs text-gray-500 dark:text-gray-400 ml-4 transition-colors duration-300">
                        ...
                        @empty
                            <div class="text-center py-6 col-span-full">
                                <i class="fas fa-book-open text-gray-400 dark:text-gray-500 text-3xl mb-2"></i>
                                <p class="text-gray-600 dark:text-gray-400 transition-colors duration-300">No active courses</p>
                            </div>
                        @endforelse
                    </div>
                </div>
        ...
        <div class="space-y-8">
            ...
            @if($showWidgets['upcoming_tasks'])
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 p-6 transition-colors duration-300">
                    <h2 class="text-xl font-bold text-gray-900 dark:text-white mb-6 transition-colors duration-300">Upcoming Tasks</h2>
                    ...
                    <div class="space-y-3">
                        @forelse($this->upcomingTasks as $task)
                            <div class="flex items-center space-x-3 p-3 rounded-lg border border-gray-200 dark:border-gray-600 hover:border-blue-300 dark:hover:border-blue-500 transition-colors">
                                ...
                                <div class="flex-1 min-w-0">
                                    <h4 class="text-sm font-medium text-gray-900 dark:text-white truncate transition-colors duration-300">{{ $task['title'] }}</h4>
                                    <p class="text-xs text-gray-600 dark:text-gray-400 transition-colors duration-300">{{ $task['course'] }}</p>
                                    <div class="flex items-center mt-1">
                                        ...
                                        <span class="text-xs text-gray-500 dark:text-gray-400 ml-2 transition-colors duration-300">{{ $task['due_date']->format('M j') }}</span>
                                    </div>
                                </div>
                                <a href="{{ $task['url'] }}" class="text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 transition-colors duration-200">
                        ...
                        @empty
                            <div class="text-center py-6">
                                ...
                                <p class="text-gray-600 dark:text-gray-400 transition-colors duration-300">No upcoming tasks</p>
                            </div>
                        @endforelse
                    </div>
                </div>
            ...
            @if($showWidgets['achievements'])
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 p-6 transition-colors duration-300">
                    <h2 class="text-xl font-bold text-gray-900 dark:text-white mb-6 transition-colors duration-300">Recent Achievements</h2>
                    ...
                    <div class="space-y-3">
                        @forelse($this->recentAchievements as $achievement)
                            <div class="flex items-center space-x-3 p-3 rounded-lg bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800/50 transition-colors duration-300">
                                ...
                                <div class="flex-1">
                                    <h4 class="text-sm font-semibold text-gray-900 dark:text-white transition-colors duration-300">{{ $achievement['name'] }}</h4>
                                    <p class="text-xs text-gray-600 dark:text-gray-400 transition-colors duration-300">{{ $achievement['description'] }}</p>
                                    <span class="text-xs px-2 py-1 rounded-full mt-1 inline-block transition-colors duration-300 {{ $achievement['rarity'] === 'legendary' ? 'bg-purple-100 dark:bg-purple-900/30 text-purple-800 dark:text-purple-300' : ($achievement['rarity'] === 'epic' ? 'bg-indigo-100 dark:bg-indigo-900/30 text-indigo-800 dark:text-indigo-300' : 'bg-blue-100 dark:bg-blue-900/30 text-blue-800 dark:text-blue-300') }}">
                                        {{ ucfirst($achievement['rarity']) }}
                                    </span>
                                </div>
                                <span class="text-xs text-gray-500 dark:text-gray-400 transition-colors duration-300">{{ $achievement['earned_at']->format('M j') }}</span>
                            </div>
                        @empty
                            <div class="text-center py-6">
                                <i class="fas fa-trophy text-gray-400 dark:text-gray-500 text-3xl mb-2"></i>
                                <p class="text-gray-600 dark:text-gray-400 transition-colors duration-300">No achievements yet</p>
                                <p class="text-xs text-gray-500 dark:text-gray-400 mt-1 transition-colors duration-300">Complete lessons to earn your first achievement!</p>
                            </div>
                        @endforelse
                    </div>
                </div>
            ...
            @if($showWidgets['career_tools'])
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 p-6 transition-colors duration-300">
                    <h2 class="text-xl font-bold text-gray-900 dark:text-white mb-6 transition-colors duration-300">Career Tools</h2>

                    <div class="space-y-4">
                        <!-- Portfolio Status -->
                        <div class="border border-gray-200 dark:border-gray-600 rounded-lg p-3 transition-colors duration-300">
                            <div class="flex items-center justify-between mb-2">
                                <span class="text-sm font-medium text-gray-700 dark:text-gray-300 transition-colors duration-300">Portfolio</span>
                                <span class="text-sm text-gray-600 dark:text-gray-400 transition-colors duration-300">{{ $this->careerTools['portfolio_completion'] }}%</span>
                            </div>
                            <div class="w-full bg-gray-200 dark:bg-gray-600 rounded-full h-2 transition-colors duration-300">
                                <div class="bg-gradient-to-r from-green-400 to-blue-500 dark:from-green-300 dark:to-blue-400 h-2 rounded-full" style="width: {{ $this->careerTools['portfolio_completion'] }}%"></div>
                            </div>
                        ...
                        <div class="border border-gray-200 dark:border-gray-600 rounded-lg p-3 transition-colors duration-300">
                            <div class="flex items-center justify-between">
                                <div>
                                    <span class="text-sm font-medium text-gray-700 dark:text-gray-300 transition-colors duration-300">Resume</span>
                                ...
                                <a href="{{ route('resume.builder') }}" class="text-xs bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600 text-gray-700 dark:text-gray-300 px-3 py-1 rounded-md transition-colors duration-200">
                        ...
                        @if(count($this->careerTools['job_applications']) > 0)
                            <div>
                                <h3 class="text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2 transition-colors duration-300">Recent Applications</h3>
                                <div class="space-y-2">
                                    @foreach($this->careerTools['job_applications'] as $application)
                                        <div class="flex items-center justify-between text-sm">
                                            <span class="text-gray-600 dark:text-gray-400 truncate transition-colors duration-300">{{ \Str::limit($application->job->title, 25) }}</span>
                                            <span class="px-2 py-1 text-xs rounded-full transition-colors duration-300 {{ $application->status_color === 'green' ? 'bg-green-100 dark:bg-green-900/30 text-green-800 dark:text-green-300' : ($application->status_color === 'yellow' ? 'bg-yellow-100 dark:bg-yellow-900/30 text-yellow-800 dark:text-yellow-300' : 'bg-gray-100 dark:bg-gray-700 text-gray-800 dark:text-gray-300') }}">
                        ...
                        <!-- Quick Actions -->
                        <div class="pt-3 border-t border-gray-200 dark:border-gray-600 transition-colors duration-300">
                            <a href="{{ route('search.job') }}" class="block text-center bg-blue-600 dark:bg-blue-500 hover:bg-blue-700 dark:hover:bg-blue-600 text-white py-2 rounded-lg text-sm font-medium transition-colors">
                                Browse Jobs
                            </a>
                        </div>
                    </div>
            ...
            <!-- System Status -->
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 p-6 transition-colors duration-300">
                <h2 class="text-lg font-bold text-gray-900 dark:text-white mb-4 transition-colors duration-300">System Status</h2>

                <div class="flex items-center space-x-3">
                    <div class="w-3 h-3 rounded-full {{ $this->systemHealth['status'] === 'operational' ? 'bg-green-500 dark:bg-green-400' : 'bg-red-500 dark:bg-red-400' }} transition-colors duration-300"></div>
                    <div>
                        ...
                        <p class="text-xs text-gray-600 dark:text-gray-400 transition-colors duration-300">{{ $this->systemHealth['message'] }}</p>
                        <p class="text-xs text-gray-500 dark:text-gray-400 mt-1 transition-colors duration-300">Updated {{ $this->systemHealth['updated_at'] }}</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    @if($showWidgets['performance_analytics'])
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 p-6 mt-8 transition-colors duration-300">
            <h2 class="text-xl font-bold text-gray-900 dark:text-white mb-6 transition-colors duration-300">Weekly Goals</h2>

            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <!-- Lessons Goal -->
                <div>
                    <div class="flex items-center justify-between mb-2">
                        <span class="text-sm font-medium text-gray-700 dark:text-gray-300 transition-colors duration-300">Lessons Completed</span>
                    ...
                    <div class="w-full bg-gray-200 dark:bg-gray-600 rounded-full h-3 transition-colors duration-300">
                        <div class="bg-gradient-to-r from-blue-500 to-purple-500 dark:from-blue-400 dark:to-purple-400 h-3 rounded-full transition-all duration-300"
                ...
                <div>
                    <div class="flex items-center justify-between mb-2">
                        <span class="text-sm font-medium text-gray-700 dark:text-gray-300 transition-colors duration-300">Study Hours</span>
                        <span class="text-sm text-gray-600 dark:text-gray-400 transition-colors duration-300">
                    ...
                    <div class="w-full bg-gray-200 dark:bg-gray-600 rounded-full h-3 transition-colors duration-300">
                        <div class="bg-gradient-to-r from-green-400 to-blue-500 dark:from-green-300 dark:to-blue-400 h-3 rounded-full transition-all duration-300"
