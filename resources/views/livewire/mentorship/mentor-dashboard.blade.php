<div class="min-h-screen bg-themed-primary transition-colors duration-300">
        ...
        <div class="container mx-auto px-6 py-8">
            <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between">
                <div class="mb-6 lg:mb-0">
                    <h1 class="text-4xl font-bold text-themed-primary mb-2 transition-colors duration-300">Mentor
                        Dashboard</h1>
                    <p class="text-xl text-themed-secondary transition-colors duration-300">Manage your mentorship
                        activities and grow your impact</p>
                </div>

                <!-- Quick Stats -->
                <div class="grid grid-cols-2 lg:grid-cols-4 gap-4">
                    <div
                        class="bg-gradient-to-br from-accent-primary to-accent-secondary rounded-xl p-4 text-white text-center">
    ...
    <div class="px-6 py-8">
        ...
        <div class="mb-8">
            <nav
                class="flex flex-wrap space-x-2 bg-themed-secondary rounded-xl p-2 shadow-sm border border-themed-primary transition-colors duration-300">
                @foreach([
                            ...
                            <button wire:click="setActiveTab('{{ $tab }}')"
                                class="transition-all duration-300 px-6 py-3 rounded-lg font-semibold {{ $activeTab === $tab
                    ? 'bg-accent-primary text-white shadow-md'
                    : 'text-themed-secondary hover:text-accent-primary hover:bg-themed-tertiary border border-transparent' }}">
       ...
       <!-- Tab  Content -->
    <div class="space-y-8" wire:loading.class="opacity-50 pointer-events-none transition-opacity duration-300">
