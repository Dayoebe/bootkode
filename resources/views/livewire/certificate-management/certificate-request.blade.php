<div class="min-h-screen bg-gray-900 p-6">
    <div>
        ...
        @else
            <!-- No Course Selected -->
            <div class="items-center bg-gray-800 rounded-2xl p-12 text-center shadow-2xl border border-gray-700">
                ...
                <div class="flex justify-center gap-4"> <!-- Center the buttons + add spacing -->
