            ...
            <div class="flex justify-between items-center py-6">
                <div class="flex items-center space-x-4">
                    ...
                    <div class="animate__animated animate__fadeInUp">
                        <h1 class="text-3xl font-bold text-gray-900">Community Center</h1>
                        <p class="text-gray-600 mt-1">Connect, collaborate, and learn with others</p>
                    </div>
                </div>
                ...
                <div class="hidden md:flex items-center space-x-6 animate__animated animate__fadeInRight">
                    <div class="text-center">
                        <div class="text-2xl font-bold text-blue-600">{{ \App\Models\ForumThread::count() }}</div>
                        <div class="text-xs text-gray-500">Discussions</div>
                    </div>
                    <div class="text-center">
                        <div class="text-2xl font-bold text-green-600">{{ \App\Models\CommunityActivity::studyGroups()->active()->count() }}</div>
                        <div class="text-xs text-gray-500">Study Groups</div>
                    </div>
                    <div class="text-center">
                        <div class="text-2xl font-bold text-orange-600">{{ \App\Models\CommunityActivity::codeChallenges()->active()->count() }}</div>
                ...
                @foreach([
                        ...
                        @if(empty($tabData['roles']) || in_array($user->role, $tabData['roles']))
                            ...
                            >
                                ...
                                @if($activeTab === $tab)
                                    <span class="ml-2 bg-blue-500 text-white text-xs px-2 py-1 rounded-full animate__animated animate__fadeInUp animate__faster">
                                        Active
                                    </span>
                                @endif
                            </button>
